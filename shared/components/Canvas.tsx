...
const Canvas= forwardRef<CanvasRef,CanvasProps>(function Canvas({onDrawingChange},ref){
    ...
    return(
    <div>
        <div ref={containerRef} className="relative w-full md:max-w-[760px] bg-white border border-gray-500 touch-none">
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                <span className="text-lg sm:text-5xl font-bold text-gray-200/70">
                    PictoMessa
                </span>
            </div>
            <Stage
        ...
        <div className="w-full max-w-[420px] m-auto flex justify-center items-center gap-2 mt-2 px-2 py-2 bg-white rounded-full shadow">
            <button 
            type="button"
            onClick={()=>{setTool("pen")}}
            className={tool === "pen" ? "bg-gray-300 p-1 sm:p-2" : "bg-white p-1 sm:p-2"}
            >
            ...
            className={tool === "eraser" ? "bg-gray-300 p-1 sm:p-2" : "bg-white p-1 sm:p-2"}
            >
                <div className="text-gray-400 text-lg sm:text-2xl">
                    <BsEraser/>
                </div>
            ...
            <div className="flex items-center border border-gray-500 rounded-full">
                {strokeOptions.map((option)=>(
                    ...
                    className={strokeWidth === option.width ? "p-1 sm:p-2 bg-gray-300 rounded-full":"p-1 sm:p-2"}
                    >
                        <span 
            ...
            type="button"
            onClick={handleUndo}
            className="p-1 sm:p-2 bg-white active:bg-gray-300"
            >
                <div className="text-gray-400 text-lg sm:text-2xl">
                    <LuUndo2 />
                </div>
